...
Refinery::Pages.configure do |config|
  ...
  config.default_parts = [{:title=>"Body", :slug=>"body"}, {:title=>"Side Body", :slug=>"side_body"}, {:title=>"Middle Body", :slug=>"middle_body"}]
  ...
  config.layout_template_whitelist = [:application, :fladeli]
